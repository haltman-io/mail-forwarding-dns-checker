...
const config = {
  ...
  DOMAIN_AUTO_APPROVE_ACTIVE: toBool(process.env.DOMAIN_AUTO_APPROVE_ACTIVE, false),
  ...
  DNS_RECHECK_ENABLED: toBool(process.env.DNS_RECHECK_ENABLED, true),
  DNS_RECHECK_STABLE_INTERVAL_SECONDS: Math.max(
    60,
    toInt(process.env.DNS_RECHECK_STABLE_INTERVAL_SECONDS || '14400', 'DNS_RECHECK_STABLE_INTERVAL_SECONDS')
  ),
  DNS_RECHECK_FAILED_INTERVAL_SECONDS: Math.max(
    60,
    toInt(process.env.DNS_RECHECK_FAILED_INTERVAL_SECONDS || '1800', 'DNS_RECHECK_FAILED_INTERVAL_SECONDS')
  ),
  DNS_RECHECK_INACTIVE_INTERVAL_SECONDS: Math.max(
    60,
    toInt(process.env.DNS_RECHECK_INACTIVE_INTERVAL_SECONDS || '86400', 'DNS_RECHECK_INACTIVE_INTERVAL_SECONDS')
  ),
  DNS_RECHECK_FAILURE_THRESHOLD: Math.max(
    1,
    toInt(process.env.DNS_RECHECK_FAILURE_THRESHOLD || '3', 'DNS_RECHECK_FAILURE_THRESHOLD')
  ),
  DNS_RECHECK_BATCH_SIZE: Math.max(
    1,
    toInt(process.env.DNS_RECHECK_BATCH_SIZE || '100', 'DNS_RECHECK_BATCH_SIZE')
  ),
  DNS_RECHECK_JITTER_PERCENT: Math.min(
    100,
    Math.max(0, toInt(process.env.DNS_RECHECK_JITTER_PERCENT || '10', 'DNS_RECHECK_JITTER_PERCENT'))
  ),
  DNS_RECHECK_WORKER_INTERVAL_SECONDS: Math.max(
    10,
    toInt(process.env.DNS_RECHECK_WORKER_INTERVAL_SECONDS || '60', 'DNS_RECHECK_WORKER_INTERVAL_SECONDS')
  ),
  DNS_RECHECK_ALERTS_ENABLED: toBool(process.env.DNS_RECHECK_ALERTS_ENABLED, true),
  DNS_RECHECK_ALERT_FOLLOWUP_INTERVAL_SECONDS: Math.max(
    60,
    toInt(
      process.env.DNS_RECHECK_ALERT_FOLLOWUP_INTERVAL_SECONDS || '43200',
      'DNS_RECHECK_ALERT_FOLLOWUP_INTERVAL_SECONDS'
    )
  ),
  DNS_RECHECK_ALERT_SUMMARY_INTERVAL_SECONDS: Math.max(
    0,
    toInt(
      process.env.DNS_RECHECK_ALERT_SUMMARY_INTERVAL_SECONDS || '86400',
      'DNS_RECHECK_ALERT_SUMMARY_INTERVAL_SECONDS'
    )
  ),
  DNS_RECHECK_ALERT_INCLUDE_RAW_JSON: toBool(process.env.DNS_RECHECK_ALERT_INCLUDE_RAW_JSON, true),
  DNS_RECHECK_ALERT_MAX_DIFF_ITEMS: Math.max(
    1,
    toInt(process.env.DNS_RECHECK_ALERT_MAX_DIFF_ITEMS || '20', 'DNS_RECHECK_ALERT_MAX_DIFF_ITEMS')
  ),
